 console.clear();
        ...
        // GSAP 3 compatibility wrapper for TweenLite and Power1
        const TweenLite = {
            to: function(target, duration, vars) {
                return gsap.to(target, Object.assign({}, vars, { duration: duration }));
            }
        };
        ...
        class Block {
            constructor(block) {
                // Define STATES and MOVE_AMOUNT as instance properties
                ...
                // create block
                let geometry = new THREE.BoxGeometry(this.dimension.width, this.dimension.height, this.dimension
                .depth);
                geometry.applyMatrix(new THREE.Matrix4().makeTranslation(this.dimension.width / 2, this.dimension.height /
                    2, this.dimension.depth / 2));
            ...
            place() {
                ...
                let overlap = this.targetBlock.dimension[this.workingDimension] - Math.abs(this.position[this
                    .workingPlane] - this.targetBlock.position[this.workingPlane]);
        ...
        class Game {
            constructor() {
                // Define STATES as instance property
                this.STATES = {
                    'LOADING': 'loading',
                    'PLAYING': 'playing',
                    'READY': 'ready',
            ...
            placeBlock() {
                ...
                if (newBlocks.chopped) {
                    ...
                    let rotationParams = {
                        delay: 0.05,
                        x: newBlocks.plane == 'z' ? ((Math.random() * rotateRandomness) - (rotateRandomness / 2)) :
                            0.1,
                        z: newBlocks.plane == 'x' ? ((Math.random() * rotateRandomness) - (rotateRandomness / 2)) :
                            0.1,
                        y: Math.random() * 0.1,
                    };
